...
import com.fm.fengmicomm.usb.task.CP210xSerialCommTask;
...
public final class USBContext {
     ...
     *                                                                          *
     * **************************************************************************/
    public static volatile USB cp210xSerialUsb;
    public static CP210xSerialCommTask cp210xSerialCommTask;
    public static volatile ArrayBlockingQueue<SerialCommand> cp210xSerialTxQueue;
}
