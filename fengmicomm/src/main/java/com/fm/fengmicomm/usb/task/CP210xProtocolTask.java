...
public class CP210xProtocolTask extends Thread {
    ...
    private void sendACK(@NonNull CP210xCommand cmd) {
        CP210xCommand ack = CP210xCommand.generateACKCMD(true, cmd);
    ...
    /**
     * 首次连接发送cmd id = 03FF 通知
     */
    private void sendConnectCmd(){
        CP210xCommand cmd = CP210xCommand.generateCommandByID("03FF");
        cp210xTxQueue.add(cmd);
    }
}
