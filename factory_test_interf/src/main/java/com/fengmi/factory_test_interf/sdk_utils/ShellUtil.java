...
public class ShellUtil {
    private static final String TAG = "Factory_ShellUtil";
    private static boolean initPass = false;
    ...
    private static StringBuilder callCommand(String command) throws IOException {
    ...
    public static boolean echoEntry(final String entry, String rts) {
        boolean ret = false;
