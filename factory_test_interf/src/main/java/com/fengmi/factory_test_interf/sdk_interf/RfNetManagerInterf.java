...
public interface RfNetManagerInterf extends BaseMiddleware {
     ...
     */
    boolean wifiSetStatus(boolean stat);
     ...
     * @return success or no.
     */
    boolean wifiConnectAp(String ssid);
     ...
     * @return success or no.
     */
    boolean wifiThroughputWithParameter(String para);
     ...
     */
    // List<ScanResult> wifiGetScanList();
     ...
     * @return success or no.
     */
    boolean btSetStatus(boolean stat);
     ...
     * @return success or no.
     */
    boolean btSetStatusBLE(boolean stat);
     ...
     * @return success or no.
     */
    boolean ethernetSetStatus(boolean stat);
     ...
     * @return success or no.
     */
    boolean ethernetPingAp(String ipaddr);
     ...
     * @return success or no.
     */
    boolean wifiPingAp(String ipaddr);

    //empty function for compatible box
    byte[] nonSigHciCmdRun(String param);

    boolean nonSigCloseNormalBt();

    boolean nonSigOpenNormalBt();

    int nonSigIsBleSupport();

    int nonSigInitBt();

    int nonSigUninitBt();

    int nonSigBleGetChipId();

    boolean enterWifi();

    boolean exitWifi();

    boolean startWifiRx(String param);

    String stopWifiRx();

    boolean startWifiTx(String param);

    boolean stopWifiTx();

    List<ScanResult> wifiGetScanList();

    boolean setBtRcMac(String param);
